...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('public/stylesheets/fontsMontserrat/css2.css') ?>">
    <link rel="stylesheet" href="<?= base_url('public/stylesheets/styles.css') ?>">

    <script type="text/javascript" src="<?= base_url('public/vendor/jquery/jquery-3.7.1.min.js') ?>"></script>
</head>
